...
if __name__ == "__main__":
    ...
    # ---------------------- 앙상블 및 제출 파일 생성 ----------------------
    alphas = [0.944, 0.008, 0.048]  # EASE, SLIM, Multi-VAE의 가중치
    ...
    # 제출 파일 생성
    recommendations_df.to_csv("ease_slim_multvae_ensemble.csv", index=False)
    print('Submission file saved as ease_slim_multvae_ensemble.csv')
